...
data_testMI['Liste_de_voeux'] = ['MMF,Actuariat', 'MMF,Actuariat', 'MMF,Actuariat', 
                                 'MMF,Actuariat', 'Actuariat,MMF', 'Actuariat,MMF', 
                                 'MMF,Actuariat', 'MMF,Actuariat', 'MMF,Actuariat', 
                                 'Actuariat,MMF', 'MMF,Actuariat']
...
save_matches_to_csv(matches, 'resultats_orientation_GMF.csv')
...
def calculate_first_choice_popularity(students_preferences):
    first_choice_counts = {option: 0 for option in ['MMF', 'Actuariat']}
...
plt.title('Popularité des options dans les premiers choix pour les étudiants de la GMF')
plt.ylim(0, 100)
plt.show()
...
plt.title("Pourcentage d'affectation en fonction du choix pour les étudiants de la GMF")
plt.ylim(0, 100)
plt.show()
